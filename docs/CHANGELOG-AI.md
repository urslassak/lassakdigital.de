...
- **MC-01** ✅ **Reaktivierung des nativen Cursors** ([style.css](file:///Users/urs/Meine%20Ablage/Work/04_Marketing/Website/style.css)): Hinzufügen von robusten CSS-Regeln (`!important`) für `.about-modal`, dessen Backdrop (`.about-modal::backdrop`), Buttons/Links sowie alle modalen Kindelemente (`.about-modal *`), um den standardmäßigen System-Mauszeiger verlässlich anzuzeigen, da native Dialoge im Top-Layer über dem Custom Cursor liegen.
- **MC-02** ✅ **Einführung einer modal-open Hilfsklasse & Ausblenden des Custom Cursors** ([js/main.js](file:///Users/urs/Meine%20Ablage/Work/04_Marketing/Website/js/main.js), [style.css](file:///Users/urs/Meine%20Ablage/Work/04_Marketing/Website/style.css)): Implementierung der Hilfsklasse `body.modal-open` bei geöffnetem Modal. Der Custom Cursor wird via `:has(dialog[open])` und `body.modal-open` komplett ausgeblendet (`display: none !important`), um doppelte Cursor oder Blockaden zu verhindern.
- **MC-03** ✅ **Escape-Key & Close-Event Handling** ([js/main.js](file:///Users/urs/Meine%20Ablage/Work/04_Marketing/Website/js/main.js)): Registrierung des `close`-Event-Listeners auf dem `<dialog>`-Element, um beim Schließen des Modals (z. B. durch Klicken des Backdrop, des Close-Buttons oder Drücken der `Escape`-Taste) die Klasse `.modal-open` und den Overflow-Blockierer sauber zurückzusetzen.
- **MC-04** ✅ **Dokumentation & Changelogs** ([CHANGELOG.md](file:///Users/urs/Meine%20Ablage/Work/04_Marketing/Website/CHANGELOG.md), [docs/CHANGELOG-AI.md](file:///Users/urs/Meine%20Ablage/Work/04_Marketing/Website/docs/CHANGELOG-AI.md), [docs/architecture.md](file:///Users/urs/Meine%20Ablage/Work/04_Marketing/Website/docs/architecture.md)): Aktualisierung der Systemarchitektur und Eintragung in den Changelogs.
